...
class CourseContent extends React.Component {
    ...
    render() {
        const style="position:absolute; left: 17.36%;top:9.77%;width:82.64%;height:170%;background:#F8F8FB;display:flex;align-items:start;padding:5%"
        const mainStyle="position:relative;width:60%;background:white;border-radius:5%;"
       return (
        <div className='course-content' Style={style}>  
            ...
            <div Style={"display:flex;flex-direction:column"}className='main'>
                <img src='images/thumbnail.png' alt="" Style={" margin-top:3%;left:5%;position:relative;aspect-ratio:1.43;width:90%;border-radius:20px"}></img>
               ...
               <Tabs className="Tabs" Style={"border:none"}>
                <TabList Style={"display:flex;margin:5%;justify-content:space-between;border:none"}>
                    <Tab Style={"border:none"}><p Style={"background:#FF7800;color:white;border-radius:20px;padding:10px 15px"}>information</p></Tab>
                    <Tab Style={"border:none"}><p Style={"color: #102844;;border-radius:20px;padding:10px 15px"} >content</p></Tab>
                    <Tab Style={"border:none"}><p Style={"color: #102844;;border-radius:20px;padding:10px 15px"}>community</p></Tab>
                    <Tab Style={"border:none"}><p Style={"color: #102844;;border-radius:20px;padding:10px 15px"}> Students</p></Tab>
                    </TabList>
                <TabPanel>
                <CourseInformation />
                </TabPanel>

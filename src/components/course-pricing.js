...
class CoursePricing extends React.Component {
    render() {
        const  style="position:relative;width:22%;height:60%;background:white;margin:0% 5%;border-radius:20px ;display:flex;flex-direction:column;justify-content:start;align-items:start"
        return(<div className="course-pricing"Style={style}>
            ...
            <p Style={'margin:0% 5% 0% 5%;font-weight:400;font-size: 12 px;line-height: 24px;color: #767278;'}> Access to IBM Cloud modelling what is I was looking for and Aaron got me the solution.</p>
            <h3 Style={'margin:2% 5% 2% 5%;color: #102844;font-weight:500'}>This course includes:</h3>
  ...
  class C extends React.Component{
    render(props){
        return(
            <div Style={"display:flex;position:relative;width:90%;margin:5%;60%; color:#102844;"}>
